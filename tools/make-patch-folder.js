...
processPatchFolder('node_modules/freepats/Drum_000',outFolder, use_gzip, /^([0-9]+).+/, (m,m1) => `d${m1}.pat`);
processPatchFolder('node_modules/freepats/Tone_000',outFolder, use_gzip, /^([0-9]+).+/, (m,m1) => `t${m1}.pat`);
