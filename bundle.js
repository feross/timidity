(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/inheritsLoose'), require('debug'), require('events')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/assertThisInitialized', '@babel/runtime/helpers/inheritsLoose', 'debug', 'events'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.timidity = factory(global._regeneratorRuntime, global._asyncToGenerator, global._createClass, global._assertThisInitialized, global._inheritsLoose, global.Debug, global.events));
}(this, (function (_regeneratorRuntime, _asyncToGenerator, _createClass, _assertThisInitialized, _inheritsLoose, Debug, events) { 'use strict';
  ...
  var debug = Debug__default['default']('timidity');
  var debugVerbose = Debug__default['default']('timidity:verbose'); // Inlined at build time by 'brfs' browserify transform
